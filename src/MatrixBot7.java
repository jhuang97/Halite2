...
public class MatrixBot7 {
	
	private final String botName = "MatrixBot7"; // occasionally decides to flee.  usually when it's too late
...
//    	Log.log(taskList.size() + " ");
    ...
    public static void main(final String[] args) {
    	MatrixBot7 myBot = new MatrixBot7();
        for (;;) {
...
//    }
    ...
    private void regroupAsNeeded() {
    	...
    	for (Integer i : thrustMoveIdx) {
    		...
    		int friendlyDocked = 0;
    		int friendlyUndocked = 0;
    		int enemyDocked = 0;
    		int enemyUndocked = 0;
    		...
    		safety += (shipList.get(i).getHealth() > 230) ? 0.96 : 0.6 + 0.3 * shipList.get(i).getHealth() / 255.0;
