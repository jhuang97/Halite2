...
public class MatrixBot5 {
	
	private final String botName = "MatrixBot5"; // 2p early game rushing, planet values, planet defense
...
//    	Log.log(taskList.size() + " ");
    ...
    public static void main(final String[] args) {
    	MatrixBot5 myBot = new MatrixBot5();
        for (;;) {
    	...
    	for (Entry<Integer, ArrayList<Ship>> e : taskAssignments.entrySet()) {
    		...
    		for (Ship ship : e.getValue()) {
    			...
    			case DEFEND_FRIENDLY_PLANET:
    				...
    				moveList.add(Navigation.navShipTowardsTarget(gameMap, 
